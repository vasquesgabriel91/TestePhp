        ...
        <form action="{{ route('pedidos.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="dtPedido" name="dtPedido" value="{{ old('dtPedido') }}" required>
                    @error('dtPedido')
                        <div class="error-text">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="qtd" name="qtd" value="{{ old('qtd') }}" required min="1" placeholder="1">
                    @error('qtd')
                        <div class="error-text">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <a href="{{ route('pedidos.store') }}" style="display: block; text-align: center; margin-top: 15px; color: #667eea; text-decoration: none;">Ver todos os pedidos</a>
        </form>
    </div>
</body>
</html>